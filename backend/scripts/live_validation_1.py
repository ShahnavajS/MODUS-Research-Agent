...
async def main():
    print("================================================================")
    print("LIVE VALIDATION TEST 1: COMPLEX ENTERPRISE BANKING AI QUESTION")
    print("================================================================")
    t0 = time.time()
    
    question_text = (
        "How are large banks deploying generative AI in fraud detection, compliance, "
        "customer service, and software engineering, and what evidence exists that the "
        "productivity and financial benefits justify the operational, cybersecurity, "
        "model-risk, and regulatory risks?"
    )

    async with AsyncSessionLocal() as session:
        p = ResearchProject(name="Banking AI Enterprise Strategy", research_topic="Generative AI in Banking")
        session.add(p)
        await session.flush()
